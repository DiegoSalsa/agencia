...
export const TRANSLATIONS: Record<Lang, Record<string, string>> = {
  es: {
    ...
    portfolio_trust_badge: '9 clientes satisfechos y contando',
    ...
    portfolio_12_desc: 'Web corporativa para consultora ambiental — ciencia, investigación y educación ambiental en Chile.',
    ...
    service_2_desc: 'Parches de seguridad, respaldos y optimización continua. Planes en /planes.',
    ...
    svc_feat_1_4: 'Rendimiento web (Core Web Vitals)',
    svc_feat_1_5: 'UI/UX Diseño personalizado',
    svc_feat_1_6: 'SEO Optimizado desde día 1',
    svc_feat_2_1: 'SSL y seguridad',
    svc_feat_2_2: 'Monitoreo y respaldos',
    ...
    svc_stat_1: 'Desde · /planes',
    svc_stat_2: 'Mantención · /planes',
    svc_stat_3: 'Cotización · /planes',
    svc_stat_ecom: 'Desde · /planes',
    ...
    faq_a7: 'Por supuesto. Puedes ver nuestro portafolio completo en la sección de arriba con proyectos reales como Caminando Otro Sendero, BioImpacto, PodomedClinical, Florería Wildgarden y ValoraLocal, entre otros.',
  ...
  en: {
    ...
    portfolio_trust_badge: '9 satisfied clients and counting',
    ...
    portfolio_12_desc: 'Corporate website for an environmental consultancy — science, research, and environmental education in Chile.',
    ...
    service_2_desc: 'Security patches, backups, and ongoing optimization. Plans on /planes.',
    ...
    svc_feat_2_1: 'SSL and security',
    svc_feat_2_2: 'Monitoring and backups',
    ...
    svc_stat_1: 'Desde · /planes',
    svc_stat_2: 'Mantención · /planes',
    svc_stat_3: 'Quote · /planes',
    svc_stat_ecom: 'From · /planes',
    ...
    faq_a7: 'Absolutely. You can see our full portfolio in the section above with real projects like Caminando Otro Sendero, BioImpacto, PodomedClinical, Florería Wildgarden, and ValoraLocal, among others.',
