...
export default function DetailedServices() {
  ...
  return (
    <div className="bg-[var(--bg)] min-h-screen relative overflow-hidden" ref={ref}>
      ...
      <div className="max-w-[1200px] mx-auto px-6 py-12 flex flex-col gap-32 md:gap-48 relative z-10">
        ...
        >
          {/* Header Block */}
          <div className="mb-16">
            <h2 className="text-4xl md:text-6xl font-black text-[var(--text)] mb-6 tracking-tight">Landing Pages <br/> de Alta Conversión.</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-16">
            {/* Main Feature */}
            <div className="md:col-span-2 rounded-3xl border border-[var(--border)] bg-[var(--bg-secondary)] p-10 relative overflow-hidden group">
              ...
              <h3 className="text-2xl font-bold text-[var(--text)] mb-4">Optimización de Conversión (CRO)</h3>
            ...
            {/* Secondary Features */}
            <div className="rounded-3xl border border-[var(--border)] bg-[var(--bg-secondary)] p-8 flex flex-col justify-center">
              <Smartphone className="w-10 h-10 text-violet-400 mb-5" />
              <h3 className="text-xl font-bold text-[var(--text)] mb-3">Mobile First</h3>
              <p className="text-sm text-[var(--text-secondary)]">Experiencia impecable y carga instantánea en dispositivos móviles.</p>
            </div>
            
            <div className="rounded-3xl border border-[var(--border)] bg-[var(--bg-secondary)] p-8 flex flex-col justify-center">
              <Search className="w-10 h-10 text-violet-400 mb-5" />
              <h3 className="text-xl font-bold text-[var(--text)] mb-3">SEO Técnico</h3>
              <p className="text-sm text-[var(--text-secondary)]">Etiquetas semánticas, Core Web Vitals y schema markup listos.</p>
            </div>

            <div className="md:col-span-2 rounded-3xl border border-[var(--border)] bg-[var(--surface)] p-8 flex items-center justify-between">
              <div>
                <h4 className="text-[var(--text)] font-bold mb-2">Tech Stack</h4>
                <div className="flex gap-3">
                  {['React', 'Next.js', 'Tailwind CSS', 'Framer Motion'].map(tech => (
                    <span key={tech} className="text-xs font-semibold px-3 py-1 bg-[var(--surface-hover)] text-[var(--text-secondary)] rounded-lg border border-[var(--border)]">{tech}</span>
                  ))}
                </div>
              </div>
          ...
          <Link href="/formulario/landing" className="inline-flex items-center gap-3 px-8 py-4 rounded-xl bg-white text-black font-bold hover:bg-violet-400 hover:text-[var(--text)] transition-colors duration-300">
        ...
        >
          ...
          <div className="mb-16 md:text-right flex flex-col md:items-end">
            <h2 className="text-4xl md:text-6xl font-black text-[var(--text)] mb-6 tracking-tight">Webs Corporativas <br/> a Medida.</h2>
            <p className="text-lg md:text-xl text-[var(--text-secondary)] max-w-2xl leading-relaxed">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-16">
            ...
            <div className="md:col-span-1 rounded-3xl border border-[var(--border)] bg-[var(--bg-secondary)] p-8 flex flex-col justify-center">
              <Lock className="w-10 h-10 text-blue-400 mb-5" />
              <h3 className="text-xl font-bold text-[var(--text)] mb-3">Seguridad Empresarial</h3>
              <p className="text-sm text-[var(--text-secondary)]">Protección contra ataques DDoS, encriptación SSL/TLS y auditorías de seguridad.</p>
            </div>
            ...
            <div className="md:col-span-2 rounded-3xl border border-[var(--border)] bg-[var(--bg-secondary)] p-10 relative overflow-hidden group">
              ...
              <h3 className="text-2xl font-bold text-[var(--text)] mb-4">CMS Personalizado y Arquitectura</h3>
              <p className="text-[var(--text-secondary)] leading-relaxed max-w-md">
            ...
            <div className="md:col-span-3 rounded-3xl border border-[var(--border)] bg-[var(--surface)] p-10 flex flex-col md:flex-row items-center justify-between gap-8">
              <div className="flex-1">
                <h4 className="text-xl font-bold text-[var(--text)] mb-6">El Proceso de Construcción</h4>
                <div className="flex flex-col sm:flex-row gap-6">
                  {['Arquitectura de Información', 'Diseño UI/UX Custom', 'Desarrollo Frontend/Backend', 'Migración y Despliegue'].map((step, idx) => (
                    <div key={idx} className="flex-1">
                      ...
                      <div className="text-sm text-[var(--text-secondary)] font-medium">{step}</div>
                    </div>
                  ))}
                </div>
              </div>
          ...
          <div className="flex md:justify-end">
            <Link href="/formulario/web-corporativa" className="inline-flex items-center gap-3 px-8 py-4 rounded-xl bg-white text-black font-bold hover:bg-blue-500 hover:text-[var(--text)] transition-colors duration-300">
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-16">
            ...
            <div className="md:col-span-2 rounded-3xl border border-[var(--border)] bg-[var(--bg-secondary)] p-10 relative overflow-hidden group">
              ...
              <h3 className="text-2xl font-bold text-[var(--text)] mb-4">Pagos sin Fricción (Checkouts)</h3>
              <p className="text-[var(--text-secondary)] leading-relaxed max-w-md">
            ...
            <div className="rounded-3xl border border-[var(--border)] bg-[var(--bg-secondary)] p-8 flex flex-col justify-center">
              ...
              <h3 className="text-xl font-bold text-[var(--text)] mb-3">Gestión de Stock</h3>
              <p className="text-sm text-[var(--text-secondary)]">Sincronización de inventario en tiempo real con tu sistema ERP.</p>
            </div>
            
            <div className="rounded-3xl border border-[var(--border)] bg-[var(--bg-secondary)] p-8 flex flex-col justify-center">
              <Search className="w-10 h-10 text-fuchsia-400 mb-5" />
              <h3 className="text-xl font-bold text-[var(--text)] mb-3">SEO E-commerce</h3>
              <p className="text-sm text-[var(--text-secondary)]">Schema markup para productos y optimización de URLs.</p>
            </div>
          ...
          <Link href="/formulario/ecommerce" className="inline-flex items-center gap-3 px-8 py-4 rounded-xl bg-white text-black font-bold hover:bg-fuchsia-500 hover:text-[var(--text)] transition-colors duration-300">
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-16">
            ...
            <div className="md:col-span-2 rounded-3xl border border-[var(--border)] bg-[var(--bg-secondary)] p-10 relative overflow-hidden group">
              ...
              <h3 className="text-2xl font-bold text-[var(--text)] mb-4">Arquitectura Cloud y Microservicios</h3>
              <p className="text-[var(--text-secondary)] leading-relaxed max-w-md">
            ...
            {/* Secondary Features */}
            <div className="rounded-3xl border border-[var(--border)] bg-[var(--bg-secondary)] p-8 flex flex-col justify-between">
              <div>
                <Server className="w-10 h-10 text-emerald-400 mb-5" />
                <h3 className="text-xl font-bold text-[var(--text)] mb-3">Integraciones API</h3>
                <p className="text-sm text-[var(--text-secondary)] mb-6">Conectamos tu sistema con Stripe, AWS, SendGrid, OpenAI y cualquier API externa que tu negocio necesite.</p>
              </div>
              
              <div>
                <h4 className="text-[var(--text)] font-bold mb-3 text-sm uppercase tracking-wider">Tech Core</h4>
          ...
          <Link href="/contacto" className="inline-flex items-center gap-3 px-8 py-4 rounded-xl bg-white text-black font-bold hover:bg-emerald-500 hover:text-[var(--text)] transition-colors duration-300">
